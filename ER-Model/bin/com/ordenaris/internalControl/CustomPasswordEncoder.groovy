...
class CustomPasswordEncoder extends MessageDigestPasswordEncoder {
    ...
    boolean isPasswordValid(String encPass, String rawPass, Object salt) {
        String crd1 = "" + encPass
        String crd2 = encodePassword(rawPass, salt)
        return PasswordEncoderUtils.equals(crd1, crd2)
        crd1 = ""
        crd2 = ""
    }
    ...
    private void encodePasswordForEvent(AbstractPersistenceEvent event) {
        if (event.entityObject instanceof User) {
            ...
            if (u.crd && ((event instanceof  PreInsertEvent) || (event instanceof PreUpdateEvent && u.isDirty('crd')))) {
                event.getEntityAccess().setProperty('crd', encodePasswordSpring(u.crd))
            }
        }
    }

    private String encodePasswordSpring(String crd) {
